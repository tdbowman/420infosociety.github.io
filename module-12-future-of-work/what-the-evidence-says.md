...
- Learn what real usage logs reveal about automation versus augmentation — what people actually hand off to AI
...
Two patterns in the map turn a technology story into a fairness story. First, exposure skews strongly by gender, largely because clerical and administrative work — historically dominated by women in much of the world — sits close to the center of what generative AI does well. Second, exposure is graded by country income level: richer countries, with more employment in information-handling occupations, have more exposed workers. The same technology, released everywhere at once, lands on a labor market that was never level to begin with. Keep those gradients in mind when you reach the "it's about power and distribution" position in the last section — this is its best evidence.
...
One capability, two modes. The same AI system can replace a task or reshape it, and the Anthropic Economic Index finds real usage split between the two. The difference is not in the model — it's in how people and organizations deploy it.
:::
...
This is the discipline the rest of the module depends on: entry-level effects in exposed occupations are real, *and* there is no mass unemployment. A quarter of the world's workers are exposed, *and* exposure mostly means transformation. People genuinely automate tasks away, *and* they genuinely collaborate with the machine. If someone's account of the future of work requires you to drop one of these findings, that's not a forecast — it's a sales pitch. The question the next section takes up is what a person entering this labor market should actually do about it.

## Up Next

The evidence says the ground is shifting under entry-level work in particular — exactly where you're standing. In [Skills and Adaptation](skills-and-adaptation.md), we turn from measurement to strategy: upskilling, reskilling, and the human skills that machines make more valuable rather than less.
