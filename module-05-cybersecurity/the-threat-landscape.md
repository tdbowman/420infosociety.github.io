...
**Phishing** is the fraudulent message designed to trick a person into surrendering credentials or running malware: an email, a text, a login page that looks exactly like the real one. It is the retail storefront of cybercrime, cheap and mass-produced, and it works because it targets people rather than machines.

**Social engineering** is the broader craft phishing belongs to: manipulating humans into defeating their own security. A caller impersonating the help desk. An "urgent" message from the boss. A fake job recruiter. Social engineering is as old as the con artist, upgraded with perfect corporate letterhead. Remember this term when we reach AI later in the module, because generative AI is very good at exactly what social engineering needs: fluent, personalized, confident text at zero cost.

**Vulnerability exploitation** is the technical route: finding a flaw in software that's exposed to the internet (a web portal, a VPN gateway, a file-transfer server) and using it to walk in without any credentials at all. According to the 2026 DBIR, exploitation of vulnerabilities has become the top initial entry vector, meaning the most common first step attackers take into victim networks. That finding deserves a pause. The most common way in is not a hoodie-wearing genius "hacking the mainframe." It is attackers systematically scanning the internet for unpatched software, for flaws that are publicly known and fixable, and getting there before the fix is applied. Much of cybersecurity failure is not a battle lost. It is maintenance not done.
...
"Hackers" is a nearly useless word, since it lumps together a teenager, a criminal cartel, and a military intelligence unit. The whole picture makes far more sense once you sort attackers by motive.
...
Criminal groups dominate the numbers, and the modern ones operate like software companies. Literally. **Ransomware-as-a-service** groups build the malware, run the payment infrastructure and the "customer support" that walks victims through paying, and lease the toolkit to *affiliates* who carry out the actual intrusions in exchange for a cut of the ransom. Remember this division of labor. It becomes darkly important in the next section, when a ransomware operator decides to cheat its own affiliate.

State-sponsored groups play a different game. They rarely announce themselves, because their product is not ransom but *presence*: quiet, durable access to systems worth spying on, or worth disabling later if relations turn hostile. Hacktivists, the third category, attack for ideology or spectacle. They matter less by volume, but they keep things unpredictable.

## Salt Typhoon: The Spies in the Phone Network

For the state-sponsored case, consider the campaign that U.S. officials disclosed in late 2024 under the name Salt Typhoon. As this week's PBS NewsHour segment reports, hackers attributed to China infiltrated at least eight U.S. telecommunications companies, the carriers that route American calls and texts. Officials described a sweeping espionage effort against the communications infrastructure itself, including access relevant to systems used for lawful wiretap requests and to communications of senior political figures.

Sit with the audacity of the target selection. Salt Typhoon did not attack particular people's phones. It attacked the network everyone's phones depend on, the layer of the information society we treat as neutral plumbing. That is state-sponsored logic in its purest form: why compromise a thousand targets individually when you can compromise the infrastructure they all share? Compare it with the criminal attacks in the DBIR data. No ransom note, no encryption, no announcement. The entire value of the operation depended on never being noticed. If ransomware is a smash-and-grab, Salt Typhoon is a mole hired into the phone company years ago and still on the payroll.

The optional Reveron and Savage reading gives this module's underlying claim its academic name: *convergence*. Your personal security, your employer's security, and national security used to be separable concerns handled by different institutions. On shared infrastructure they collapse into one problem, because the same telecom breach touches the teenager's texts, the corporation's deals, and the government's secrets at once.

One more addition to the picture: the DBIR's 2026 edition added new data on AI-assisted threats, meaning attackers using AI to write malware and craft more convincing phishing at scale. Hold that thread. The final section of this module pulls it hard.
